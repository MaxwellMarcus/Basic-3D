...
def new_creatures(event):
    ...
    for i in range(num_creatures):
        creatures.append(Creature(random.randint(minSpeed,maxSpeed)))
    last = None
    for i in range(15):
        for l in creatures:
            l.run()
        ...
        for i in range(11):
            ...
            canvas.create_text(20,lastY-(i*10)*3,text=str(i*maxSpeed/10),font=('TkTextFont',20))
